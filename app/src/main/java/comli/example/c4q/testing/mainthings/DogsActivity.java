...
public class DogsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!breedName.equals("")){
            ...
            Call<BreedPiclIST> breedImgListCall = breedService.getList(breedName);
            breedImgListCall.enqueue(new Callback<BreedPiclIST>() {
                @Override
                public void onResponse(Call<BreedPiclIST> call, Response<BreedPiclIST> response) {
                ...
                @Override
                public void onFailure(Call<BreedPiclIST> call, Throwable t) {
                    t.printStackTrace();
                    dialog.dismiss();
                }
            });
